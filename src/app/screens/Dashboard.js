...
class RenderHouse extends React.Component {
  ...
  renderActionModal = () => {
    return (
      <Modal
        isVisible={this.state.visibleInviteResident}
  ...
  render() {
    ...
    return (
      <View style={styles.houseContainer}>
        ...
        <DoubleClick
          singleTap={() => this.onSinglePress(h_no, neighborID)}
          doubleTap={() => this.onDoublePress(h_no, neighborID)}
          delay={2500}
          styles={[
